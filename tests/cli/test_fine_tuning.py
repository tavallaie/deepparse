...
from deepparse.cli import fine_tuning
...
class RetrainTests(RetrainTestCase):
    ...
    def set_up_params(
        ...
        test_dataset_path=None,  # None to handle the default tests case.
        train_ratio="0.8",
        batch_size="32",
        ...
        if test_dataset_path is None:
            test_dataset_path = self.a_train_pickle_dataset_path
    ...
    def test_integration_cpu(self):
        ...
        fine_tuning.main(parser_params)
